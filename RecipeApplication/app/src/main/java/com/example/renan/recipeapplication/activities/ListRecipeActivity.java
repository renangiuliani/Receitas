...
import com.example.renan.recipeapplication.Util.DrawerMenuUtil;
...
import com.example.renan.recipeapplication.adapter.ListRecipeAdapter;
import com.example.renan.recipeapplication.adapter.RecipeTypeAdapter;
...
public class ListRecipeActivity extends AppCompatActivity {
    ...
    private ArrayList<EnumRecipeType> recipeTypes;
        ...
        rvListRecipe.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == 0) {
                    ...
                    Animation displacement = new TranslateAnimation(0, 0, 200, 0);
                    displacement.setDuration(300);
                    fbAddRecipe.startAnimation(displacement);
                } else if(newState == 1){
                    Animation displacement = new TranslateAnimation(0, 0, 0, 200);
                    displacement.setDuration(300);
                    fbAddRecipe.startAnimation(displacement);
    ...
    private void createAndPopulateRecipeTypeArray() {
        ...
        recipeTypes = new ArrayList<EnumRecipeType>();
        recipeTypes.add(EnumRecipeType.MEAT);
        recipeTypes.add(EnumRecipeType.BIRD);
        recipeTypes.add(EnumRecipeType.FISH);
        recipeTypes.add(EnumRecipeType.PASTA);
        recipeTypes.add(EnumRecipeType.SALAD);
        recipeTypes.add(EnumRecipeType.SOUP);
        recipeTypes.add(EnumRecipeType.BREAD);
        recipeTypes.add(EnumRecipeType.CANDY);
        recipeTypes.add(EnumRecipeType.DRINK);
        recipeTypes.add(EnumRecipeType.SAUCE);
    }
