...
import com.example.renan.recipeapplication.activities.RecipeActivity;
...
public class RecipeTypeAdapter extends RecyclerView.Adapter<RecipeTypeAdapter.RecipeTypeViewHolder> {
    ...
    private ArrayList<EnumRecipeType> itens;
    private Dialog dialog;

    public RecipeTypeAdapter(Context context, ArrayList<EnumRecipeType> itens, Dialog dialog) {
    ...
    public void onBindViewHolder(final RecipeTypeViewHolder viewHolder, final int position) {
        viewHolder.ivPicture.setImageResource(itens.get(position).getImage());
